...
const Projects = () => {
    ...
    return (
        <Layout>
            ...
            {/* Services Section */}
            {services.length > 0 && (
                <section className="projects-services-section">
                    <div className="projects-services-container">
                        <div className="projects-services-header">
                            <span className="projects-services-badge">Our Services</span>
                            <h2 className="projects-services-title">
                                What We Offer
                            </h2>
                            <p className="projects-services-description">
                                Comprehensive solutions tailored to meet your business needs and drive growth
                            </p>
                            {/* <Link to="/services" className="projects-services-cta">
                        ...
                        <div className="projects-services-grid">
                            {services.map((service, index) => (
                                <div key={service.id} className="service-item-card">
                                    <div className="service-item-header">
                                        {/* <div className="service-item-number">{index + 1}</div> */}
                                        ...
                                        <div className="service-item-overlay">
                                            <span className="service-view-details">View Details</span>
                                        </div>
                                    </div>
                                    
                                    <div className="service-item-content">
                                        <span className="service-item-tag">Service</span>
                                        <h3 className="service-item-name">{service.title}</h3>
                                        <p className="service-item-description">{service.short_description}</p>
